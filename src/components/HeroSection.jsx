      ...
      <div className="relative z-10 lg:w-[60%] md:w-[90%] w-full px-6 sm:px-10 md:px-20 py-15 sm:py-24">
        ...
        >
          <Link
            href="/contact"
            hrefLang="en"
            aria-label="Book a service or contact Pandi Auto Spare – High-quality car spare parts in Perinthalmanna, Malappuram"
          >
          ...
          <Link
            href="/products"
            hrefLang="en"
            aria-label="Explore car spare parts at Pandi Auto Spare – OEM and aftermarket parts in Perinthalmanna, Malappuram"
          >
